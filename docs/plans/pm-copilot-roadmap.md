...
- [ ] Create `/extensions/jira/` with basic API client
- [ ] Implement 3 Jira tools: create, search, update issue
- [ ] Create `/skills/bug-triage/` skill
- [ ] Test end-to-end: Slack message → Jira ticket
